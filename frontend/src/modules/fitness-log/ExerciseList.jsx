...
function SetRow({ setNum, set, lastSet, onChange }) {
  ...
  return (
    <div className="flex items-center gap-2 py-1.5">
      ...
      {hint && <span className="text-xs text-blue-400/70 ml-0.5 tabular-nums">{hint}</span>}
    </div>
  )
}

function ExerciseCard({ ex, index, lastSets, onChange, onRemove }) {
...
export default function ExerciseList({ exercises, onChange, lastSession = {} }) {
